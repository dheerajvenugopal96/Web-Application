...
<title>Eduversity Education Category Flat Bootstrap Responsive Website Template | Home : W3layouts</title>
    ...
    <body>
        ...
        <div class="content">
            ...
            <h3 style="margin-bottom: 2%;">All Notes</h3>
            <table><tr><th>Subject Name</th><th>Video</th><th>Pdf</th><th>Ppt</th><th>Doc</th></tr>
                       <%
                           ...
                           String query="Select DISTINCT(SUBJECT_NAME) from NOTE";
                       ...
                       %>
                    <tr><td><%= rs.getString("SUBJECT_NAME") %></td><td><a href="showvideo.html?sub=<%= rs.getString("SUBJECT_NAME") %>"><img src="images/video.png"></a></td><td><a href="showpdf.html?sub=<%= rs.getString("SUBJECT_NAME") %>"><img src="images/pdf.png"></a></td><td><a href="showppt.html?sub=<%= rs.getString("SUBJECT_NAME") %>"><img src="images/ppt.png"></a></td><td><a href="showdoc.html?sub=<%= rs.getString("SUBJECT_NAME") %>"><img src="images/doc.png"></a></td></tr> 
