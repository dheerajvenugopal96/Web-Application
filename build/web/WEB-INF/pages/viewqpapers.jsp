      ...
      <nav class="navbar navbar-inverse">
		...
		<div class="main-page">
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
                    <table><tr><th>S.No.</th><th>Subject</th><th>Question Paper Year</th><th>Download paper</th></tr>
                        <% int i=0;%>
                        
                        
                        <c:forEach items="${list}" var="i">
                            
                            <c:if test="${i.year eq year}">
                                
                                <tr><td><%= ++i%></td><td>${i.subject}</td><td>${i.qyear}</td><td><a href="downloadexcel.html?filename=${i.filename}"><i class="fa fa-download"></i></a></td></tr>
