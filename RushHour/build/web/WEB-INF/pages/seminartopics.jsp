	   ...
	   <div class="inner-content">
		<!-- header-starts -->
			...
			<!-- top_bg -->
				...
				<!--content-->
			<div class="content">
                            <h3 style="text-align: center;font-weight: bold;">Upload Seminar Topic</h3>
                            <form>
									...
									<ul id="menu" >
										<li><a href="home.html"><i class="fa fa-tachometer"></i> <span>Home</span></a></li>
                                                                                ...
                                                                                <li><a href="verifystaff.html"><i class="fa fa-group"></i><span>Staff Approval</span></a></li>
                                                                                  <li><a href="seminartopics.html"><i class="fa fa-plus"></i><span>Upload Seminar Topics</span></a></li>
