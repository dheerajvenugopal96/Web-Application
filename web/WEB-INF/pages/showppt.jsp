...
<title>Eduversity Education Category Flat Bootstrap Responsive Website Template | Home : W3layouts</title>
    ...
    <body>
        ...
        <div class="content">
            ...
            <table><tr><th>Topic Name</th><th>Chapter Name</th><th>Module</th><th>Year</th><th>Uploaded by</th><th>Download File</th></tr>
                <c:forEach items="${list}" var="i">
                    <tr><td>${i.topic}</td><td>${i.topicdescription}</td><td>${i.module}</td><td>${i.year}</td><td>${i.studentname}</td><td><a href="download.html?id=${i.id}"><i class="fa fa-download"></i></a></td></tr>
                </c:forEach>
