		...
		<div id="page-wrapper">
                     <div class="main-page">
                        <div class="blank-page widget-shadow scroll" id="style-2 div1">
                            ...
                            <input type="submit" value="SEARCH" style="border:none;background-color: black;color:white;">
                            
                            </form>
                            </c:if>
                            <c:if test="${not empty list2}">
                            <table><tr><th>Book Name</th><th>Author Name</th><th>Book Availability</th></tr>
                                
                                <c:forEach items="${list2}" var="j">
                                    
                                    <tr><td>${j.bookname}</td><td>${j.author}</td><td>
                                            
                                            <c:if test="${j.avlstatus eq 'Available'}">
                                            
                                                <p style="color:green;font-weight: bold;">${j.avlstatus}</p>
                                        
                                        </c:if>
                                    
                                    <c:if test="${j.avlstatus eq 'Unavailable'}">
                                        
                                          <p style="color:red;font-weight: bold;">${j.avlstatus}</p>
                                    </c:if>
                                    </td></tr>
                                </c:forEach>
