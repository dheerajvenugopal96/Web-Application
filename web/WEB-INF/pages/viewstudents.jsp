	   ...
	   <div class="inner-content">
		<!-- header-starts -->
			...
			<div class="content">
                            ...
                            <table><tr><th>Student Name</th><th>Email</th><th>Year</th><th>Mobile</th><th>View Report</th></tr>
                            
                            <c:forEach items="${list}" var="i">
                                <tr><td>${i.fname} ${i.lname}</td><td>${i.email}</td><td>${i.year}</td><td>${i.mobile}</td><td><a href="viewreport.html?id=${i.id}"><i class="fa fa-eye">  </i></a></td></tr>
