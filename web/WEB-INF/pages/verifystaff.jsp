	   ...
	   <div class="inner-content">
		<!-- header-starts -->
			...
			<div class="content">
                            ...
                            <table><tr><th>Staff Name</th><th>Email</th><th>Mobile</th><th>Year</th><th>Approve</th></tr>
                            <c:forEach items="${list}" var="i">
                                    <tr><td>${i.fname} ${i.lname}</td><td>${i.email}</td><td>${i.mobile}</td><td>${i.year}</td><td><a href="approve.html?id=${i.id}"><i class="fa fa-check" style="color:greenyellow"></i></a></td></tr>
