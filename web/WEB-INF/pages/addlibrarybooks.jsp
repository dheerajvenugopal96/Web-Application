	   ...
	   <div class="inner-content">
		<!-- header-starts -->
			...
			<!-- top_bg -->
				...
				<!--content-->
			<div class="content">
                            <form action="bookadd.html" method="post" autocomplete="off">
                                ...
                                <label>Book Name</label>
                                        ...
                                        Available<input type="radio" name="avl" value="Available" checked="checked"> Unavailable<input type="radio" name="avl" value="Unavailable">
                            ...
                            <a href="cavl.html" style="background-color:black;color:white;padding:10px;">Change Availability Status</a>
			</div>
			<!--content-->
		</div>
</div>
