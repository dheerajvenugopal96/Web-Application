		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
                                    ...
                                    <form action="addrequest.html" method="post" onsubmit="return success()">
                                    <h1 style="width:40%;">Internal Marks </h1>
                                    
                                    <select name="staffid" style="width: 22%;padding: 10px;margin-top: 1%;margin-bottom: 1%;">
                                        <c:forEach items="${list}" var="i">
                                        <option value="${i.id}">${i.fname} ${i.lname} - ${i.year} year</option>
                                        </c:forEach>
                                    </select>
                                    <br><input type="submit" value="Request" style="border:1px solid black;border-radius: 5px;padding:2px;background-color: blue;color:white;font-weight: bold;">
                                    </form>
                                    ...
                                    <c:if test="${not empty list2}">
                                        ...
                                        int i=0;
                                        %>
                                        <table><tr><th>S.No</th><th>Request Status</th><th>Filename</th><th>Download File</th></tr>
                                            
                                            <c:forEach items="${list2}" var="i">
                                                
                                                
                                                <tr><td><%= ++i%></td><td>${i.requeststatus}</td><td>${i.filename}</td><td><a href="downloadexcel.html?filename=${i.filename}"><i class="fa fa-download" style="color:blue;"></i></a></td></tr>
