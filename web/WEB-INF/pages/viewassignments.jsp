      ...
      <nav class="navbar navbar-inverse">
		...
		<div class="main-page">
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
                    <table><tr><th>S.No.</th><th>Subject</th><th>Assignment Topic</th><th>Deadline</th></tr>
                        <% int i=0;%>
                        ...
                        <c:forEach items="${list}" var="i">
                            ...
                            <c:if test="${i.year eq year}">
                                ...
                                <tr><td><%= ++i%></td><td>${i.subject}</td><td>${i.topicname}</td><td style="color:red;">${i.deadline}</td></tr>
