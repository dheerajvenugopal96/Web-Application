...
<body>
    ...
    <c:set var="category" value="${sessionScope.category}"></c:set>
				...
				<ul class="navbar-nav ml-lg-auto text-center">
					...
					<li class="nav-item mr-lg-3">
						<a class="nav-link" href="viewnotes.html">View Notes</a>
                                        ...
                                        <c:if test="${category eq 'student'}">
					<li class="nav-item mr-lg-3">
						<a class="nav-link" href="userdash.html">User Dashboard</a>
					</li>
					</c:if>
                                      <c:if test="${category eq 'staff'}">
					<li class="nav-item mr-lg-3">
						<a class="nav-link" href="uploadmarklist.html">Marks</a>
					</li>
                                        
                                        <li class="nav-item mr-lg-3">
						<a class="nav-link" href="addassignments.html">Assignments</a>
					</li>
                                        
                                        <li class="nav-item mr-lg-3">
						<a class="nav-link" href="sendmessage.html">Send Message</a>
					</li>
					</c:if>
